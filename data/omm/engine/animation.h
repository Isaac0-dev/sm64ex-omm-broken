...
#define retrieve_animation_index(frame, attributes) geo_obj_retrieve_animation_index(frame, attributes)
#define geo_update_animation_frame(animInfo, ...) ((s16) (geo_obj_update_animation_frame(animInfo) / ANIM_ACCEL_ONE))
