...
#define ACT_OMM_WATER_GROUND_POUND_LAND             (0x01 | ACT_GROUP_SUBMERGED | ACT_FLAG_OMM_ACTION | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING)
#define ACT_OMM_WATER_GROUND_POUND_JUMP             (0x02 | ACT_GROUP_SUBMERGED | ACT_FLAG_OMM_ACTION | ACT_FLAG_SWIMMING | ACT_FLAG_OPEN_HANDS)
#define ACT_OMM_WATER_DASH                          (0x03 | ACT_GROUP_SUBMERGED | ACT_FLAG_OMM_ACTION | ACT_FLAG_SWIMMING | ACT_FLAG_OPEN_HANDS)
#define ACT_OMM_CAPPY_THROW_WATER                   (0x04 | ACT_GROUP_SUBMERGED | ACT_FLAG_OMM_ACTION | ACT_FLAG_SWIMMING | ACT_FLAG_OPEN_HANDS)
#define ACT_OMM_LEAVE_OBJECT_WATER                  (0x05 | ACT_GROUP_SUBMERGED | ACT_FLAG_OMM_ACTION | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_OPEN_HANDS | ACT_FLAG_ENABLE_HEAD_ROTATION)
#define ACT_OMM_GRABBED_WATER                       (0x06 | ACT_GROUP_SUBMERGED | ACT_FLAG_OMM_ACTION | ACT_FLAG_STATIONARY | ACT_FLAG_INVULNERABLE | ACT_FLAG_SWIMMING | ACT_FLAG_OPEN_HANDS)
...
#define ACT_OMM_METAL_WATER_START_CROUCHING         (0x02 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_OMM_METAL_WATER_STOP_CROUCHING          (0x04 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_PAUSE_EXIT)
#define ACT_OMM_METAL_WATER_START_CRAWLING          (0x05 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_OMM_METAL_WATER_STOP_CRAWLING           (0x07 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_PAUSE_EXIT)
#define ACT_OMM_METAL_WATER_JUMP                    (0x08 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR | ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
#define ACT_OMM_METAL_WATER_DOUBLE_JUMP             (0x0A | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR | ACT_FLAG_CONTROL_JUMP_HEIGHT)
#define ACT_OMM_METAL_WATER_DOUBLE_JUMP_LAND        (0x0B | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_OMM_METAL_WATER_TRIPLE_JUMP             (0x0C | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR)
#define ACT_OMM_METAL_WATER_TRIPLE_JUMP_LAND        (0x0D | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_OMM_METAL_WATER_BACKFLIP                (0x0E | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR)
#define ACT_OMM_METAL_WATER_BACKFLIP_LAND           (0x0F | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_OMM_METAL_WATER_SIDE_FLIP               (0x10 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR)
#define ACT_OMM_METAL_WATER_SIDE_FLIP_LAND          (0x11 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_OMM_METAL_WATER_LONG_JUMP               (0x12 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR)
#define ACT_OMM_METAL_WATER_LONG_JUMP_LAND          (0x13 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_OMM_METAL_WATER_FREEFALL                (0x14 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR)
#define ACT_OMM_METAL_WATER_FREEFALL_LAND           (0x15 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_OMM_METAL_WATER_WALL_SLIDE              (0x16 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR)
#define ACT_OMM_METAL_WATER_WALL_KICK_AIR           (0x17 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR | ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
#define ACT_OMM_METAL_WATER_GROUND_POUND_LAND_STOP  (0x1D | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY)
...
#define ACT_OMM_METAL_WATER_SPIN_GROUND             (0x24 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_MOVING)
...
#define ACT_OMM_METAL_WATER_HOLD_IDLE               (0x29 | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_OMM_METAL_WATER_HOLD_JUMP               (0x2B | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_AIR | ACT_FLAG_CONTROL_JUMP_HEIGHT)
#define ACT_OMM_METAL_WATER_HOLD_JUMP_LAND          (0x2C | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_OMM_METAL_WATER_HOLD_FREEFALL_LAND      (0x2E | ACT_GROUP_METAL_WATER | ACT_FLAG_OMM_ACTION | ACT_FLAG_METAL_WATER | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#if OMM_GAME_IS_R96X
