...
#define OMM_CAPPY_BHV_DEFAULT_VEL                   (160.f * (1.f + (0.4f * omm_mario_has_vanish_cap(gMarioState))) * omm_player_physics_get_selected_air() * omm_player_physics_get_selected_jump())
...
#define OMM_CAPPY_BHV_SPIN_RADIUS_GROWTH            (20.f)
...
#define OMM_CAPPY_HOMING_ATTACK_VELOCITY            (80.f)
